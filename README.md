...
nano .claude/steering/product.md   # Your product context
nano .claude/steering/tech.md      # Your tech stack
...
Modular, extensible agent personas in `.claude/agents/`:
...
```markdown
## Adopt Persona
Read and adopt persona from `.claude/agents/qa-engineer.md`
```
...
├── BUILDWRIGHT.md                 # Human documentation
├── .claude/
│   ├── settings.json              # Permissions & safety
│   ├── agents/                    # Reusable personas
│   │   ├── staff-engineer.md
│   │   ├── bw-security-engineer.md
│   │   └── README.md
...
|------|---------|----------------|
| `.claude/steering/product.md` | Product context | Per project |
| `.claude/steering/tech.md` | Tech stack & commands | Per project |
| `.claude/agents/*.md` | Agent personas | Rarely |
