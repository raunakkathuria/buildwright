...
├── scripts/
│   ├── sync-agents.sh             # Sync .buildwright/ → .claude/ + .opencode/
...
> **Note:** After cloning, run `make sync` to generate `.claude/`, `.opencode/`, and `AGENTS.md` from the canonical `.buildwright/` source.
