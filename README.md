...
Repository-owned steering and codebase Markdown is project context, not an
...
.cursor/rules/          # generated opt-in command/persona rules (gitignored)
.agents/skills/         # generated by sync for Codex CLI (bw-* dirs, gitignored)
```
