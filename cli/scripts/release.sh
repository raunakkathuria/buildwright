...
# Step 1: bump the npm package and maintained skill metadata versions
make bump BUMP="$BUMP"
...
git add cli/package.json cli/package-lock.json clawhub/buildwright/SKILL.md .buildwright/commands/bw-*.md
...
echo ""
echo "Manual step — publish ClawHub with release and discovery metadata:"
echo "  clawhub skill publish clawhub/buildwright --version $NEW_VERSION --tags latest --categories development,agents --topics tdd,code-review,security-review,software-development,agent-workflows --changelog \"Release v$NEW_VERSION\""
